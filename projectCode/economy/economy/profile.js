...
$description[1;
**Progress
Money: $getVar[symbol]$numberSeparator[$getGlobalUserVar[Wallet;$findUser[$message;yes]];,]
...
please contact my ower** \`$userTag[$botownerid]\` **If you have know the dev lock the command**}}]`
}