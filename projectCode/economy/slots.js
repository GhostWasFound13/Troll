...
$setUserVar[wallet;$sum[$getUserVar[wallet];$truncate[$multi[2;$message]]]]
$else
...
$setUserVar[wallet;$sub[$getUserVar[wallet;$authorID];$truncate[$message]];$authorID]
$endif
$endif
...
$onlyIf[$getUserVar[wallet;$authorID]>=$truncate[$message];$getServerVar[error] **$username** You don't have that much credits]
