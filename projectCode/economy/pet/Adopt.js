...
$onlyIf[$getGlobalUserVar[Wallet]>14999;**<:panda:918918705050693642> Paul wont come with you unless you get 15,000$getVar[symbol] **]
$else
$if[$message==dog]
...
$onlyIf[$getGlobalUserVar[Wallet]>9999;**<:dog:918932976258129960> brownie wont come with you unless you get 10,000$getVar[symbol] **]
$else
$if[$message==cat]
...
$onlyIf[$getGlobalUserVar[Wallet]>999;**<:cat:918933580812537876> bella wont come with you unless you get 1,000$getVar[symbol] **]
$else
