...
$setUserVar[wallet;$sum[$getUserVar[wallet];$message[2]]]
$else
$getServerVar[check] **$username** You have chosen $message[1]
$editIn[5s;$getServerVar[error] **$username** You lost your bet $numberSeparator[$message[2];,]$getServerVar[symbol]]
$setUserVar[wallet;$sub[$getUserVar[wallet];$message[2]]]
$endif
$onlyIf[$getUserVar[wallet]>=$multi[1;$message[2]];$getServerVar[error] **$username** You don't have that many credits]
