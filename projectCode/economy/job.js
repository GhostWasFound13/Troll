...
$onlyIf[$getGlobalUserVar[Wallet]>999;{newEmbed: {color:RED} {description:**You do not meet the requirements of [1,000]($getBotInvite)$getVar[symbol] you currentl have [$numberSeparator[$geGlobalUserVar[Waller];,]]($getBotInvite)$getVar[symbol]**}}]
$suppressErrors
$else
$if[$message==developer]
**You now work as a developer**
$setGlobalUserVar[job;developer]
$onlyIf[$getGlobalUserVar[Wallet]>2499;{newEmbed: {color:RED} {description:**You do not meet the requirements of [2,500]($getBotInvite)$getVar[symbol] you currentl have [$numberSeparator[$geGlobalUserVar[cash];,]]($getBotInvite)$getVar[symbol]**}}]
$suppressErrors
$else
$if[$message==actor]
**You now work as an actor**
$setGlobalUserVar[job;actor]
$onlyIf[$getGlobalUserVar[Wallet]>4999;{newEmbed: {color:RED} {description:**You do not meet the requirements of [5,000]($getBotInvite)$getVar[symbol] you currentl have [$numberSeparator[$geGlobalUserVar[Wallet];,]]($getBotInvite)$getVar[symbol]}}]
$suppressErrors
$endif
$endif
$endif
...
please contact my ower** \`$userTag[$botownerid]\` **If devloper still upon the command we are sorry**}}]`}
